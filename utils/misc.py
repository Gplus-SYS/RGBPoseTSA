...
def seg_pool_1d(video_fea_1, video_1_st, video_1_ed, fix_size):#video_fea_1.shape=[1,64,96],type(video_1_st) = int,fix_size=5
    ...
    return video_1_segs # shape = [1,64,15]

def seg_pool_3d(video_feamap_2, video_2_st, video_2_ed, fix_size):#video_fea_1.shape=[1,64,96,4,4],type(video_1_st) = int,fix_size=5
    ...
    return video_2_segs_map # shape = [1,64,15,4,4]
