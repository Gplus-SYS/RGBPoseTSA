model = dict(
    multi_modality = 'early_fusion',
    updata_by_which_path = 'RGB',  #['RGB','Pose','Double']
    backbone=dict(
        rgb_path = dict(
...
## bash train.sh RGBPoseI3D_early_fusion configs/FineDiving_RGBPoseI3D_early_fusion.py 2
